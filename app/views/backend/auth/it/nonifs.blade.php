...
@section('konten')
<h3 class="warning">Dokumen Non-Ifs</h3>
...
<div class="alertMsg danger">
	...
	<ul id="form-errors">
		...
		{{ $errors->first('file_document_nonifs', '<li>:message</li>') }}
	</ul>
</div>
@endif
...
<div class="row">
	<div class="col-md-8">
		<p class="lead">Berikut daftar dokumen Non-IFS :</p>
	</div>
	<div class="col-md-4">
	...
	<tbody>
		...
		<tr>
			...
			<td class="tool-tip" title="Download File">
				<a href="{{ $divisi }}{{ $temp->file_document_nonifs }}"><i class="fa fa-download"></i></a>
			</td>
			<td class="tool-tip" title="Hapus File">
				<a href="{{ route('hapusnonifs', $temp->id) }}" onclick="if(!confirm('Anda yakin akan menghapus file ini?')){return false;};" title="Hapus File"><i class="fa fa-times"></i></a>
			</td>
		</tr>
		@endforeach
...
<div class="alertMsg default">
	<i class="fa fa-minus-square-o"></i> Anda belum memiliki file dokumen Non-IFS.	
</div>
@endif
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header modal-warning">
				...
				<h4 class="modal-title">Tambah Dokumen Non-ISF</h4>
			</div>
			{{ Form::open(['route'=>'nonifsbaru', 'POST', 'autocomplete'=>'off', 'files'=>'true']) }}\
			{{ Form::token() }}
				<div class="modal-body">
					...
					<div class="form-group">
						<h3 class="warning">
							{{ Form::label('file_document_nonifs', 'Pilih file yg ingin Anda Unggah') }}
						</h3>
						{{ Form::file('file_document_nonifs') }}
					</div>
				</div>
