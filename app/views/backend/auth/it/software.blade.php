...
@section('konten')
<h3 class="warning">Software Sumalindo</h3>
...
<div class="alertMsg danger">
	...
	<ul id="form-errors">
		...
		{{ $errors->first('file_software', '<li>:message</li>') }}
	</ul>
</div>
@endif
...
<div class="row">
	<div class="col-md-8">
		<p class="lead">Berikut daftar software yang digunakan.</p>
	</div>
	<div class="col-md-4">
	...
	<tbody>
		...
		<tr>
			...
			<td class="tool-tip" title="Download File">
				<a href="{{ $divisi }}{{ $temp->file_software }}"><i class="fa fa-download"></i></a>
			</td>
			<td class="tool-tip" title="Hapus File">
				<a href="{{ route('hapussoftware', $temp->id) }}" onclick="if(!confirm('Anda yakin akan menghapus file ini?')){return false;};" title="Hapus File"><i class="fa fa-times"></i></a>
			</td>
		</tr>
		@endforeach
...
<div class="alertMsg default">
	<i class="fa fa-minus-square-o"></i> Belum ada software yang digunakan.	
</div>
@endif
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header modal-warning">
				...
				<h4 class="modal-title">Tambah Software</h4>
			</div>
			{{ Form::open(['route'=>'softwarebaru', 'POST', 'autocomplete'=>'off', 'files'=>'true']) }}\
			{{ Form::token() }}
				<div class="modal-body">
					<div class="form-group">
						...
						<span class="help-block">Nama Software yang digunakan.</span>
					</div>
					<div class="form-group">
						<h3 class="warning">		
						...
						<span class="help-block">Masukkan keterangan software yang mungkin dibutuhkan. <strong>*Optional</strong>.</span>
					</div>
					<div class="form-group">
						<h3 class="warning">
							{{ Form::label('file_software', 'Pilih master software yg ingin Anda Unggah') }}
						</h3>
						{{ Form::file('file_software') }}
					</div>
				</div>
