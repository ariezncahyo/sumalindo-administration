...
class PlymillTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        DB::table('plymill_sop')->insert($Sop);
        DB::table('plymill_laporan')->insert($Laporan);
        DB::table('plymill_struktur')->insert($Struktur);
    }
